        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    <div>
                        <img src="./assets/img/admin-avatar2.png" width="45px" />
                    </div>
                    <div class="admin-info">
                        <div class="font-strong">Izanagi</div><small>Admin DfLab</small></div>
                </div>
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-inbox"></i>
                    ...
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-bookmark"></i>
                            <span class="nav-label">Order Master</span></a>
                    </li>
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-user"></i>
                            <span class="nav-label">User List</span></a>
                    </li>
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-phone"></i>
                            <span class="nav-label">Contact us</span></a>
                    </li>
                </ul>
            </div>
        </nav>
            ...
            <div class="page-brand">
                <a class="link" href="index.html">
                    <span class="brand">DF
                        <span class="brand-tip">LAB admin</span>
                    </span>
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            <img src="./assets/img/admin-avatar2.png" />
                            <span></span>Izanagi<i class="fa fa-angle-down m-l-5"></i></a>
